import pandas as pd
import os
def audioset_process_csv(input_path, target_path):
  ...
  selected.to_csv(os.path.join(output_path, 'balanced_train_segments_processed.csv'), header=False, index=False)
